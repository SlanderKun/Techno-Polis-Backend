    ...
    return services.internship_service.shemas.InternshipListResponse(
        ...
        internships=[
            services.internship_service.shemas.InternshipData(
                ...
                name="Name",
                logo=None,
                company_name="Угабуга политех",
                platform="ПС4",
                speciality="Вайбкодер",
                responsibilities="Быть вайбовым, порядочным, на кондициях",
                requirements="Без зависимостей пж!",
                official_employment=None,
                work_shedule=None,
                work_place="Где по кайфу",
                map_place="РОССИЯ!!!",
                probation=None,
                salary="За идею!",
                extra="Экстра",
                text_promo="#freedurov",
                web_link="https://vk.ru",
                promo_link="https://mos.ru",
                confidencial=True,
                mailings=True,
                sms_ad=True,
            )
